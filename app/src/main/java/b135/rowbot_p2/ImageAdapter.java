...
public class ImageAdapter extends PagerAdapter {
    ...
    private int[] sessionImageIds = new int[]
            {R.drawable.powergraph, R.drawable.sketchy, R.drawable.embedvideoph};
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ImageView imageView = new ImageView(sessionContext);
        imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
        imageView.setImageResource(sessionImageIds[position]);
